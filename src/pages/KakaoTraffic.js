...
const KakaoTraffic = () => {
  ...
  const onSearchMapHandler = () => {
    if (departure === arrival) {
      ...
      window.open(
        `kakaomap://route?sp=${departureY},${departureX}&ep=${arrivalY},${arrivalX}&by=CAR`
      );
    }
  };
    ...
    <div className="kakaoTraffic">
      ...
      <div className="kakaoContentWrap">
        <div className="departure">
          <div className="departureTitle">📍출발지 선택</div>
        ...
        <div className="arrival">
          <div className="arrivalTitle">📍도착지 선택</div>
        ...
        <div className="searchButton" onClick={onSearchMapHandler}>
          <div className="searchButtonWrap">길 찾기 실행하기</div>
        </div>
      </div>
    </div>
  );
